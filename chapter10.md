...
* 症例対照研究：マッチングにより選択バイアスが生じることがある。そのような場合にはマッチング後に層化が必要。#oy 表7-5参照。症例には男性が多く、男性は曝露している人が多いような場合、性別でマッチングすると対照群も曝露者が多くなってしまい(表7-4)、層化が必要になっている(表7-5)。そもそも、マッチングせずに普通に対照群をサンプリングして、層化すればよい(第7章での議論参照)。
